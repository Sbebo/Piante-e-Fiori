...
{
    public sealed partial class AltriFruttiDetailControl : UserControl
    {
        public AltriFrutti MasterMenuItem
        {
            get { return GetValue(MasterMenuItemProperty) as AltriFrutti; }
            set { SetValue(MasterMenuItemProperty, value); }
        }

        public static readonly DependencyProperty MasterMenuItemProperty = DependencyProperty.Register("MasterMenuItem", typeof(AltriFrutti), typeof(AltriFruttiDetailControl), new PropertyMetadata(null, OnMasterMenuItemPropertyChanged));
        ...
        public AltriFruttiDetailControl()
        {
            InitializeComponent();
        ...
        {
            var control = d as AltriFruttiDetailControl;
        ...
        private void climaeterreno_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(climaeterrenotxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo le informazioni sul clima e il terreno...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private void cureconsigliate_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(cureconsigliatetxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo le cure consigliate...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private void raccoltaeconservazione_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(raccoltaeconservazionetxt.Text);
        ...
        private void varietà_radiobutton_Checked(object sender, RoutedEventArgs e)
        {

...
{
    public sealed partial class PianteAcquaticheeRivaDetailControl : UserControl
    {
        public PianteAcquatiche MasterMenuItem
        {
            get { return GetValue(MasterMenuItemProperty) as PianteAcquatiche; }
            set { SetValue(MasterMenuItemProperty, value); }
        }

        public static readonly DependencyProperty MasterMenuItemProperty = DependencyProperty.Register("MasterMenuItem", typeof(PianteAcquatiche), typeof(PianteAcquaticheeRivaDetailControl), new PropertyMetadata(null, OnMasterMenuItemPropertyChanged));
        ...
        public PianteAcquaticheeRivaDetailControl()
        {
            InitializeComponent();
        ...
        {
            var control = d as PianteAcquaticheeRivaDetailControl;
        ...
        private async void duplica_finestra_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            await newView.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                frame.Navigate(typeof(PianteAcquaticheeRivaPage), null);

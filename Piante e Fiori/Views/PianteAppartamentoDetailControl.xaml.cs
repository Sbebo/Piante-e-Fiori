...
{
    public sealed partial class PianteAppartamentoDetailControl : UserControl
    {
        public PianteAppartamento MasterMenuItem
        {
            get { return GetValue(MasterMenuItemProperty) as PianteAppartamento; }
            set { SetValue(MasterMenuItemProperty, value); }
        }

        public static readonly DependencyProperty MasterMenuItemProperty = DependencyProperty.Register("MasterMenuItem", typeof(PianteAppartamento), typeof(PianteAppartamentoDetailControl), new PropertyMetadata(null, OnMasterMenuItemPropertyChanged));
        ...
        public PianteAppartamentoDetailControl()
        {
            InitializeComponent();
        ...
        {
            var control = d as PianteAppartamentoDetailControl;
        ...
        private async void duplica_finestra_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            await newView.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                frame.Navigate(typeof(PianteAppartamentoPage), null);

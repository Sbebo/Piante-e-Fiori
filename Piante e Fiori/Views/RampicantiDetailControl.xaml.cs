...
{
    public sealed partial class RampicantiDetailControl : UserControl
    {
        public Rampicanti MasterMenuItem
        {
            get { return GetValue(MasterMenuItemProperty) as Rampicanti; }
            set { SetValue(MasterMenuItemProperty, value); }
        }

        public static readonly DependencyProperty MasterMenuItemProperty = DependencyProperty.Register("MasterMenuItem", typeof(Rampicanti), typeof(RampicantiDetailControl), new PropertyMetadata(null, OnMasterMenuItemPropertyChanged));
        ...
        public RampicantiDetailControl()
        {
            InitializeComponent();
        ...
        {
            var control = d as RampicantiDetailControl;
        ...
        private void altre_caratteristiche_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(sintesitxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo la scheda di sintesi...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private async void duplica_finestra_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            await newView.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                frame.Navigate(typeof(RampicantiPage), null);

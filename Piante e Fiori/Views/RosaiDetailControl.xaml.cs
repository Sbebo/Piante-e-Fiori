...
{
    public sealed partial class RosaiDetailControl : UserControl
    {
        public Rosai MasterMenuItem
        {
            get { return GetValue(MasterMenuItemProperty) as Rosai; }
            set { SetValue(MasterMenuItemProperty, value); }
        }

        public static readonly DependencyProperty MasterMenuItemProperty = DependencyProperty.Register("MasterMenuItem", typeof(Rosai), typeof(RosaiDetailControl), new PropertyMetadata(null, OnMasterMenuItemPropertyChanged));
        ...
        {
            var control = d as RosaiDetailControl;
        ...
        private async void duplica_finestra_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            await newView.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                frame.Navigate(typeof(RosaiPage), null);

...
{
    public sealed partial class ArbustiDetailControl : UserControl
    {
        public Arbusti MasterMenuItem
        {
            get { return GetValue(MasterMenuItemProperty) as Arbusti; }
            set { SetValue(MasterMenuItemProperty, value); }
        }

        public static readonly DependencyProperty MasterMenuItemProperty = DependencyProperty.Register("MasterMenuItem", typeof(Arbusti), typeof(ArbustiDetailControl), new PropertyMetadata(null, OnMasterMenuItemPropertyChanged));
        ...
        {
            var control = d as ArbustiDetailControl;
        ...
        private async void duplica_finestra_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            await newView.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                frame.Navigate(typeof(ArbustiPage), null);
        ...
        private async void cerca_informazioni_pianta_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            //await Launcher.LaunchUriAsync(new Uri("NomeComunePianta}"));
        }

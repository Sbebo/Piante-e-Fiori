...
{
    public sealed partial class AlberiDetailControl : UserControl
    {
        public Alberi MasterMenuItem
        {
            get { return GetValue(MasterMenuItemProperty) as Alberi; }
            set { SetValue(MasterMenuItemProperty, value); }
        }

        public static readonly DependencyProperty MasterMenuItemProperty = DependencyProperty.Register("MasterMenuItem", typeof(Alberi), typeof(AlberiDetailControl), new PropertyMetadata(null, OnMasterMenuItemPropertyChanged));
        ...
        {
            var control = d as AlberiDetailControl;
        ...
        private async void duplica_finestra_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            await newView.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                frame.Navigate(typeof(AlberiPage), null);
        ...
        /**
        private async System.Threading.Tasks.Task InvokePrintingButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (Windows.Graphics.Printing.PrintManager.IsSupported())
            {
                ...
                catch
                {
                    ...
                    ContentDialog noPrintingDialog = new ContentDialog()
                    {
                        ...
                        Content = "\nSiamo spiacenti, ma non è possibile procedere con la stampa",
            ...
            else
            {
                ...
                ContentDialog noPrintingDialog = new ContentDialog()
                {
                    Title = "Funzione stampa non supportata",
                    Content = "\nSiamo spiacenti, ma la funzione di stampa non è supportata in questo dispositivo.",
                    PrimaryButtonText = "OK"
                };
                await noPrintingDialog.ShowAsync();
            }

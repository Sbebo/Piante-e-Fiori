...
{
    public sealed partial class ErbaceePerenniDetailControl : UserControl
    {
        public ErbaceePerenni MasterMenuItem
        {
            get { return GetValue(MasterMenuItemProperty) as ErbaceePerenni; }
            set { SetValue(MasterMenuItemProperty, value); }
        }

        public static readonly DependencyProperty MasterMenuItemProperty = DependencyProperty.Register("MasterMenuItem", typeof(ErbaceePerenni), typeof(ErbaceePerenniDetailControl), new PropertyMetadata(null, OnMasterMenuItemPropertyChanged));
        ...
        public ErbaceePerenniDetailControl()
        {
            InitializeComponent();
        ...
        {
            var control = d as ErbaceePerenniDetailControl;
        ...
        private async void duplica_finestra_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            await newView.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                frame.Navigate(typeof(ErbaceePerenniPage), null);

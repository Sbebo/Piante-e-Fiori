...
{
    public sealed partial class PianteAnnualiDetailControl : UserControl
    {
        public PianteAnnuali MasterMenuItem
        {
            get { return GetValue(MasterMenuItemProperty) as PianteAnnuali; }
            set { SetValue(MasterMenuItemProperty, value); }
        }

        public static readonly DependencyProperty MasterMenuItemProperty = DependencyProperty.Register("MasterMenuItem", typeof(PianteAnnuali), typeof(PianteAnnualiDetailControl), new PropertyMetadata(null, OnMasterMenuItemPropertyChanged));
        ...
        public PianteAnnualiDetailControl()
        {
            InitializeComponent();
        ...
        {
            var control = d as PianteAnnualiDetailControl;
        ...
        private async void duplica_finestra_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            await newView.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                frame.Navigate(typeof(PianteAnnualiPage), null);

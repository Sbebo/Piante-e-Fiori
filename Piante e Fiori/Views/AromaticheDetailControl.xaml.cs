...
{
    public sealed partial class AromaticheDetailControl : UserControl
    {
        public Aromatiche MasterMenuItem
        {
            get { return GetValue(MasterMenuItemProperty) as Aromatiche; }
            set { SetValue(MasterMenuItemProperty, value); }
        }

        public static readonly DependencyProperty MasterMenuItemProperty = DependencyProperty.Register("MasterMenuItem", typeof(Aromatiche), typeof(AromaticheDetailControl), new PropertyMetadata(null, OnMasterMenuItemPropertyChanged));
        ...
        public AromaticheDetailControl()
        {
            InitializeComponent();
        ...
        {
            var control = d as AromaticheDetailControl;
        ...
        private void introduzione_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(introduzionetxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo l'introduzione...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private void descrizione_coltivazione_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(descrizione_coltivazionetxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo la descrizione e i metodi di coltivazione...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private void raccolta_conservazione_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(raccolta_conservazionetxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo i metodi di raccolta e conservazione...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private void salute_bellezza_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(salute_bellezzatxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo le proprietà per la salute e la bellezza...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private void incucina_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(incucinatxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo gustose ricette a base di erbe aromatiche...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private void propagazione_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(propagazionetxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo i metodi di propagazione...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private void potatura_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(potaturatxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo i metodi di potatura...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private async void duplica_finestra_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            await newView.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                frame.Navigate(typeof(AromatichePage), null);

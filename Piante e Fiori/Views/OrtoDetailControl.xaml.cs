...
{
    public sealed partial class OrtoDetailControl : UserControl
    {
        public Orto MasterMenuItem
        {
            get { return GetValue(MasterMenuItemProperty) as Orto; }
            set { SetValue(MasterMenuItemProperty, value); }
        }

        public static readonly DependencyProperty MasterMenuItemProperty = DependencyProperty.Register("MasterMenuItem", typeof(Orto), typeof(OrtoDetailControl), new PropertyMetadata(null, OnMasterMenuItemPropertyChanged));
        ...
        {
            var control = d as OrtoDetailControl;
        ...
        private void semina_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(seminatxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo le operazioni di semina...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private void cure_colturali_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(cure_colturalitxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo le cure colturali...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private void raccolta_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(raccoltatxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo i metodi di raccolta...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private void proprietà_benefici_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(proprietà_beneficitxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo le proprietà e i benefici dell'ortaggio...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private void varietà_consigliate_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(varietàtxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo le principali varietà...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private async void duplica_finestra_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            await newView.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                frame.Navigate(typeof(OrtoPage), null);

...
{
    public sealed partial class PianteEsoticheDetailControl : UserControl
    {
        public PianteEsotiche MasterMenuItem
        {
            get { return GetValue(MasterMenuItemProperty) as PianteEsotiche; }
            set { SetValue(MasterMenuItemProperty, value); }
        }

        public static readonly DependencyProperty MasterMenuItemProperty = DependencyProperty.Register("MasterMenuItem", typeof(PianteEsotiche), typeof(PianteEsoticheDetailControl), new PropertyMetadata(null, OnMasterMenuItemPropertyChanged));
        ...
        public PianteEsoticheDetailControl()
        {
            InitializeComponent();
        ...
        {
            var control = d as PianteEsoticheDetailControl;
        ...
        private async void duplica_finestra_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            await newView.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                frame.Navigate(typeof(PianteEsotichePage), null);

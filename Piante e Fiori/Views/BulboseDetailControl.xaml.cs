...
{
    public sealed partial class BulboseDetailControl : UserControl
    {
        public Bulbose MasterMenuItem
        {
            get { return GetValue(MasterMenuItemProperty) as Bulbose; }
            set { SetValue(MasterMenuItemProperty, value); }
        }

        public static readonly DependencyProperty MasterMenuItemProperty = DependencyProperty.Register("MasterMenuItem", typeof(Bulbose), typeof(BulboseDetailControl), new PropertyMetadata(null, OnMasterMenuItemPropertyChanged));
        ...
        {
            var control = d as BulboseDetailControl;
        ...
        private async void duplica_finestra_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            await newView.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                frame.Navigate(typeof(BulbosePage), null);

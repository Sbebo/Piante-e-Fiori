...
{
    public sealed partial class FruttetoDetailControl : UserControl
    {
        public Frutteto MasterMenuItem
        {
            get { return GetValue(MasterMenuItemProperty) as Frutteto; }
            set { SetValue(MasterMenuItemProperty, value); }
        }

        public static readonly DependencyProperty MasterMenuItemProperty = DependencyProperty.Register("MasterMenuItem", typeof(Frutteto), typeof(FruttetoDetailControl), new PropertyMetadata(null, OnMasterMenuItemPropertyChanged));
        ...
        {
            var control = d as FruttetoDetailControl;
        ...
        private void storia_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(storiatxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo la storia e le curiosità della pianta...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private void caratteristiche_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(caratteristichetxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo le caratteristiche botaniche...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private void problemiesoluzioni_radiobutton_Checked(object sender, RoutedEventArgs e)
        {
            ReadSsmlText(problemiesoluzionitxt.Text);
            sintetizzatore_statustxt.Text = "Sto riproducendo i problemi e le soluzioni...";
            pr1.Visibility = Visibility.Visible;
            cortana_fiore.Visibility = Visibility.Collapsed;
        ...
        private async void duplica_finestra_btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            await newView.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
            {
                ...
                frame.Navigate(typeof(FruttetoPage), null);

...
// LIBERIA PER CREARE APPUNTAMENTI SUL CALENDARIO
    ...
    public class CalendarService 
    {
            ...
            TextBox subject, TextBox location, TextBox details, ComboBox duration, CheckBox allDay)
        {
            ...
            if (string.IsNullOrEmpty(id))
                Show("Trattamento pianta non aggiunto al calendario", "Piante e Fiori App");
            else
                Show(string.Format("Trattamento Pianta n° {0} aggiunto al calendario", id), "Piante e Fiori App");
        }
